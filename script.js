...
let lastName = prompt("Enter lasst name");
...
const getRandomEmployee = function (employeesArray) {
  ...
  document.getElementById('random-employee').textContent = `Random Employee: ${randomEmployee.firstName} ${randomEmployee.lastName}`;
};
